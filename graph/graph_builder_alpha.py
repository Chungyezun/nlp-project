...
class GraphBuilder:
    def __init__(self, lambda1=0.5, lambda2=0.5, gamma=1, b=1, embedder=None, union_mode="avg", cost_mode="default", delta_mode="max", alpha=0.3, use_precomputed=False, precomputed_path=None, precomputed_data=None):
